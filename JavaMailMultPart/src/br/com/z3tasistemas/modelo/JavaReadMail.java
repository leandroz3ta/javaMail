...
public class JavaReadMail {
    ...
    public static void main(String[] args) {
        ...
        try {
        	//Aqui inciaremos a conexão com o servidor de emails
            ...
            //Ela será aberta em modo somente leitura
            ...
            //Daqui em diante é onde a dor de cabeça começa...
            
            /*O método multipart é responsável por pegar o conteúdo da variável
             * msg e analisar sua estrutura*/
            Multipart mp = (Multipart) msg.getContent();
            
            /*
             * O método bodypart pega o corpo da mensagem que está na variável mp*/
            BodyPart bp = mp.getBodyPart(0);
            
            /*
             * O método MimeMultipart pega o conteúdo da varíavel msg
             * e analisa se ela contém algum tipo de arquivo
             * */
            ...
            /*O laço for irá analisar o conteudo da variável multipart*/
            for (int j = 0; j < multipart.getCount(); j++) {
                ...
                String disposition = bodyPart.getDisposition();
                	...
                	/*Caso seja encontrado algum anexo ele exibirá informação do arquivo*/
                  if (disposition != null && (disposition.equalsIgnoreCase("ATTACHMENT"))) { // BodyPart.ATTACHMENT doesn't work for gmail
                	  ...
                	  //Caso não haja, ele imprime o conteúdo da mensagem como texto simples
            ...
            /*A problemática do negócio...
             * Se o email possui anexo, por alguma razão que até então eu desconheço,
             * o algoritmo quando configurado como IMAP, não retorna a string do 
             * mpp.getContent().toString() mas retorna um objeto do tipo
             * javax.mail.internet.MimeMultipart@
             * já procurei na internet uma solução para o problema mas não obtive sucesso.
             * Este problema não ocorre quando utilizo POP3, porém este protocolo
             * não trabalha com comandos remotos igual o IMAP faz...
             * Preferencialmente irei utilizar o protocolo IMAP por várias razões,
             * sendo uma delas o fato de poder trabalhar as mensagens remotamente
             * no servidor sem a necessidade de baixá-las para a maquina local.
             * */
